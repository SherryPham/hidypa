# evaluate_hi_dypa_robustness.py
# Script to evaluate robustness to deletion attacks for hi_dypa multi-user watermarking
...
def main():
    parser = argparse.ArgumentParser(
        description="Evaluate robustness to deletion attacks for hi_dypa multi-user watermarking",
    ...
    # Print header
    print("\n" + "="*80)
    print(" " * 20 + "HI-DYPA ROBUSTNESS EVALUATION")
    print("="*80)
    print(f"\nConfiguration:")
