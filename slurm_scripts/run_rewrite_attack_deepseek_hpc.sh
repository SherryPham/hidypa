...
# =============================================================================
# SLURM Job Configuration — Table 7: Robustness to LLM-based rewriting (DeepSeek-7B, OzSTAR)
# Uses Apptainer container instead of venv
# =============================================================================
#SBATCH --job-name=hidypa_rewrite_deepseek
...
cd ${CODE_DIR}
mkdir -p slurm_out
mkdir -p evaluation/rewrite_attack
...
# Download NLTK punkt tokenizer if not already present (needed for sent_tokenize)
echo "Checking NLTK punkt tokenizer..."
...
echo "Running LLM-based rewrite attack evaluation (9 configurations) with DeepSeek-LLM-7B"
echo "Rewrite ratios: 5%, 10%, 15%, 20% x modes: start, middle, end, random"
echo ""
...
echo "=========================================="
${APPTAINER_RUN} python3 /workspace/evaluation_scripts/evaluate_rewrite_attack.py \
    --scheme naive \
    --l-bits 8 \
    ...
    --z-threshold 4.0 \
    --max-new-tokens 400 \
    --output-dir /workspace/evaluation/rewrite_attack \
    --run-tag ${RUN_TAG}
...
echo ""
echo "=========================================="
echo "All 9 LLM rewrite attack configurations complete!"
echo "Results saved to evaluation/rewrite_attack/"
echo "=========================================="
