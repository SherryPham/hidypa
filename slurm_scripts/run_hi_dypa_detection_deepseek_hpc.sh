...
# =============================================================================
# SLURM Job Configuration — Table 2: Clean-text detection (DeepSeek-7B, OzSTAR)
# Uses Apptainer container instead of venv
# =============================================================================
#SBATCH --job-name=hidypa_detection_deepseek
...
echo "Running Table 2: Clean-text detection (9 configurations) with DeepSeek-LLM-7B"
echo ""
