...
# =============================================================================
# SLURM Job Configuration — Table 3: Collusion tracing (DeepSeek-7B, OzSTAR)
# Uses Apptainer container instead of venv
# =============================================================================
#SBATCH --job-name=hidypa_collusion_deepseek
...
cd ${CODE_DIR}
mkdir -p slurm_out
mkdir -p evaluation/collusion_resistance
...
echo "Running Table 3: Collusion tracing (8 configurations) with DeepSeek-LLM-7B"
echo ""
...
echo "=========================================="
${APPTAINER_RUN} python3 /workspace/evaluation_scripts/compare_collusion_resistance.py \
    --scheme naive \
    --l-bits 8 \
    ...
    --z-threshold 4.0 \
    --max-new-tokens 400 \
    --output-dir /workspace/evaluation/collusion_resistance \
    --run-tag ${RUN_TAG}
...
echo ""
echo "=========================================="
echo "All 8 configurations complete!"
echo "Results saved to evaluation/collusion_resistance/"
echo "=========================================="
