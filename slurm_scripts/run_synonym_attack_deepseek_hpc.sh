...
# =============================================================================
# SLURM Job Configuration — Robustness to synonym substitution (DeepSeek-7B, OzSTAR)
# Uses Apptainer container instead of venv
# =============================================================================
#SBATCH --job-name=hidypa_synonym_deepseek
...
cd ${CODE_DIR}
mkdir -p slurm_out
mkdir -p evaluation/synonym_attack
...
# Download WordNet corpus if not already present (runs on compute node before going offline)
echo "Checking NLTK WordNet corpus..."
${APPTAINER_RUN} python3 -c "
import os, nltk
...
echo "Running synonym substitution evaluation (9 configurations) with DeepSeek-LLM-7B"
echo "Synonym ratios: 5%, 10%, 15%, 20% x modes: start, middle, end, random"
echo ""
...
echo "=========================================="
${APPTAINER_RUN} python3 /workspace/evaluation_scripts/evaluate_synonym_attack.py \
    --scheme naive \
    --l-bits 8 \
    ...
    --z-threshold 4.0 \
    --max-new-tokens 400 \
    --output-dir /workspace/evaluation/synonym_attack \
    --run-tag ${RUN_TAG}
...
echo ""
echo "=========================================="
echo "All 9 synonym substitution configurations complete!"
echo "Results saved to evaluation/synonym_attack/"
echo "=========================================="
